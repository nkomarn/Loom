    ...
    static {
        try {
            ...
            methods.put(
                    ...
                    (server, args) -> CraftMagicNumbers.INSTANCE
            );
            methods.put(
            ...
            methods.put(Server.class.getMethod("getLootTable", NamespacedKey.class),
                    (server, args) -> {
                        ...
                        return new CraftLootTable(key, AbstractTestingBase.LOOT_TABLE_REGISTRY.getTable(CraftNamespacedKey.toMinecraft(key)));
                    }
            );
