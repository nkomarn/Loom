...
public class BlockDataTest extends AbstractTestingBase {
    ...
    public void testParsing() {
        BlockData cakeTest = CraftBlockData.fromData(Blocks.CAKE.getDefaultState().with(CakeBlock.BITES, 3));
    ...
    public void testClone() {
        Cake cakeTest = (Cake) CraftBlockData.fromData(Blocks.CAKE.getDefaultState().with(CakeBlock.BITES, 3));
    ...
    public void testCannotMerge1() {
        ...
        Chest two = (Chest) CraftBlockData.fromData(Blocks.CHEST.getDefaultState());
    ...
    public void testMatch() {
        ...
        Chest one = (Chest) CraftBlockData.fromData(Blocks.CHEST.getDefaultState().with(ChestBlock.FACING, Direction.EAST));
    ...
    public void testGetAsString2() {
        Chest data = (Chest) CraftBlockData.fromData(Blocks.CHEST.getDefaultState().with(ChestBlock.FACING, Direction.EAST));
