...
public class CraftMapRenderer extends MapRenderer {
    ...
    public void render(MapView map, MapCanvas canvas, Player player) {
        ...
        for (Object key : worldMap.icons.keySet()) {
            ...
            cursors.addCursor(decoration.getX(), decoration.getZ(), (byte) (decoration.getRotation() & 15),
                    decoration.getType().getId(), true, CraftChatMessage.fromComponent(decoration.getText()));
        }
    }
