...
public abstract class CraftEntity implements org.bukkit.entity.Entity {
    ...
    public boolean teleport(Location location, TeleportCause cause) {
        ...
        if (!location.getWorld().equals(getWorld())) {
            entity.changeDimension(((CraftWorld) location.getWorld()).getHandle(), new BlockPos(location.getX(), location.getY(), location.getZ()));
            return true;
        }
    ...
    public List<org.bukkit.entity.Entity> getPassengers() {
        return Lists.newArrayList(Lists.transform(getHandle().getPassengerList(),
                (Function<Entity, org.bukkit.entity.Entity>) input -> input.getBukkitEntity()));
    }
