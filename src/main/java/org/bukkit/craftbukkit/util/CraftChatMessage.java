...
public final class CraftChatMessage {
    ...
    private static final class StringMessage {
        private static final Pattern INCREMENTAL_PATTERN = Pattern.compile("(" + ChatColor.COLOR_CHAR
        ...
        private static final Pattern INCREMENTAL_PATTERN_KEEP_NEWLINES = Pattern.compile("("
                ...
                + ".\\?!,;:]?(?:[" + String.valueOf(org.bukkit.ChatColor.COLOR_CHAR) + " ]|$))))", Pattern.CASE_INSENSITIVE);
